<?php
$page_title = "Pismo Beach Painter | Spectrum Painting & Fine Finishes";
include('../../../parts/header.php'); 
?>

<body class="portfolio portfolio-region pismo-beach">
	<header>
	...
	<div id="tabs" class="container">
		...
		<div class="med-content">
			<div id="commercial">
				<h1 class="page-title">Pismo Beach Painting</h1>
