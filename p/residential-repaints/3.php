...
<section class="landing-quote">
  ...
  <form method="POST" id="repaints-form">
    <h1 class="t-white">Get 10% Off</h1>
    <p class="t-white">For a limited time, Spectrum Painting is offering a 10% discount for first-time customers!</p>
    ...
    <input type="hidden" name="source" value="3: 10% Off"></input>
