<?php include_once('../mail-landing.php'); ?>
...
<section class="landing-quote">
  ...
  <form method="POST" id="repaints-form">
    ...
    <p class="t-white">Get a free estimate on paint work through the form below.</p>
    ...
    <input type="hidden" name="source" value="1: Regular Landing Page"></input>
